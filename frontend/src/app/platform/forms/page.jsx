...
import { ArrowRight, FileText, Smartphone, CheckSquare } from "lucide-react";
        ...
        <div className="min-h-screen bg-white">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
                            ...
                            <h1 className="text-5xl md:text-6xl font-bold text-slate-900 mb-6">Forms & Ticketing</h1>
                            <p className="text-xl text-slate-600 mb-8">Streamline field operations with customizable digital forms, automated workflows, and intelligent ticketing systems.</p>
                        ...
                        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="aspect-video rounded-2xl overflow-hidden border border-slate-200 shadow-xl">
                            <Image src="https://images.pexels.com/photos/2850347/pexels-photo-2850347.jpeg?auto=compress&cs=tinysrgb&w=1200" alt="Forms" width={1200} height={675} className="w-full h-full object-cover" />
                        </motion.div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-bold text-slate-900 mb-4">Digital Workflow Management</h2>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            { icon: FileText, title: "Custom Forms", description: "Build any form you need with drag-and-drop simplicity." },
                            { icon: Smartphone, title: "Mobile-First", description: "Capture data offline and sync when connected." },
                            { icon: CheckSquare, title: "Smart Ticketing", description: "Auto-generate tickets from form submissions and inspection findings." }
                        ].map((benefit, idx) => (
            ...
            <section className="py-20 bg-gradient-to-br from-orange-600 to-orange-700">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-4xl font-bold text-white mb-6">Go paperless today</h2>
